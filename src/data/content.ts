  ...
  fr: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          title: "VisualSigns Academy - Plateforme de Formation",
          type: "Projet Fullstack",
          description:
            "Site web vitrine et dashboard administratif pour une école de formation à Boumerdès, avec système d'inscription en ligne, gestion des inscriptions, blog, FAQ et support trilingue. Hébergé sur Vercel.",
          features: [
            "Site vitrine SPA",
            "Dashboard admin",
            "Backend REST API avec authentification JWT et autorisation par rôles",
            "Gestion des inscriptions avec suivi de statut ",
            "Gestion des comptes utilisateurs",
            "Support trilingue (FR/EN/AR)",
            "Hébergement Vercel avec rewrite SPA",
          ...
          demo: "https://visualsignsacademy.com/",

          image: "projects/visualsigns-cover.png",
        },
      ],
    },
    educationSection: {
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          title: "VisualSigns Academy - Training Platform",
          type: "Fullstack Project",
          description:
            "Student-facing website and admin dashboard for a training school in Boumerdès, featuring an online registration system, enrollment management, blog, FAQ, and trilingual support. Hosted on Vercel.",
          features: [
            "SPA landing page (Hero, Courses, Blog, FAQ, Testimonials, CTA)",
            "Admin dashboard (stats, enrollment management, user management, settings)",
            "REST API backend with JWT authentication and role-based authorization",
            "Enrollment tracking with status workflow (New → Contacted → Confirmed/Rejected)",
            "User account management (CRUD, roles: Admin/Teacher/Student, activation toggle)",
            "Trilingual support (FR/EN/AR) via i18next",
